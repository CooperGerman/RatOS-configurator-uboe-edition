...
export function getDcEndstopConfigurationFileContent(forceDefault: boolean, fileName: string): string {
	return getCommonBoilerplateConfigurationFileContent(forceDefault, fileName, 'CONFIGURE_DC_ENDSTOP');
}

export function getAdjustYMaxConfigurationFileContent(forceDefault: boolean, fileName: string): string {
